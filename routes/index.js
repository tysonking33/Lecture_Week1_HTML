...
router.post('/login', async function(req,res,next){
    ...
    if ('client_id' in req.body && 'credential' in req.body){
      ...
      req.pool.getConnection(function(cerr, connection) {
        ...
        let query = "SELECT id,handle,pass, avatar,email,display_name FROM Users WHERE handle = ?";

        connection.query(query, [req.body.username,hash], async function(qerr, rows, fields) {
...
router.post('/signup', function(req,res,next){
  ...
  if ('username' in req.body && 'password' in req.body) {
    ...
    req.pool.getConnection(async function(cerr, connection) {
      ...
      connection.query(query, [req.body.username,hash,req.body.username],function(qerr, rows, fields) {
